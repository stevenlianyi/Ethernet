...
#else
//#define SS_PIN_DEFAULT  10
#define SS_PIN_DEFAULT  ESP32_SPI_SS_PIN //Steven Lian 2020/09/05
#endif
...
uint8_t  W5100Class::ss_pin = ESP32_SPI_SS_PIN; //Steven Lian 2020/09/05
...
uint8_t W5100Class::init(void)
{
	...
	//SPI.begin();
	//SPI.begin(sck = ESP32_SPI_SCK_PIN,miso = ESP32_SPI_MISO_PIN,mosi = ESP32_SPI_MOSI_PIN,ss = ESP32_SPI_SS_PIN); //Steven Lian added 2020/09/05
	SPI.begin(ESP32_SPI_SCK_PIN,ESP32_SPI_MISO_PIN,ESP32_SPI_MOSI_PIN,ESP32_SPI_SS_PIN); //Steven Lian added 2020/09/05
	initSS();
	resetSS();
